jQuery(document).ready(function( $ ) {
  ...
  $(document).ready(function (params) {
    const allCards = document.querySelectorAll('.governace .card-event');
    allCards.forEach(card => {
        card-event.classList.add('is-clickable');
        card-event.setAttribute('data-toggle', 'modal');
        card-event.setAttribute('data-target', '#exampleModal')
       card-event.addEventListener('click',()=> displayInfo(card))
    })
})
